...
_SOLUTIONNAME = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TASKS_FACEDETECTOR', index=15, number=15,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TASKS_FACELANDMARKER', index=16, number=16,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TASKS_FACESTYLIZER', index=17, number=17,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TASKS_INTERACTIVESEGMENTER', index=18, number=18,
      options=None,
      type=None),
  ],
  containing_type=None,
