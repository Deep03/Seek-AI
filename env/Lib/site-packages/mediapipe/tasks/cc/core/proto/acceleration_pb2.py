...
_ACCELERATION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='nnapi', full_name='mediapipe.tasks.core.proto.Acceleration.nnapi', index=3,
...
_ACCELERATION.fields_by_name['nnapi'].message_type = mediapipe_dot_calculators_dot_tensor_dot_inference__calculator__pb2._INFERENCECALCULATOROPTIONS_DELEGATE_NNAPI
...
_ACCELERATION.oneofs_by_name['delegate'].fields.append(
  _ACCELERATION.fields_by_name['nnapi'])
_ACCELERATION.fields_by_name['nnapi'].containing_oneof = _ACCELERATION.oneofs_by_name['delegate']
