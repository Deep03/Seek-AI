...
_FACESTYLIZERGRAPHOPTIONS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='face_landmarker_graph_options', full_name='mediapipe.tasks.vision.face_stylizer.proto.FaceStylizerGraphOptions.face_landmarker_graph_options', index=1,
...
_FACESTYLIZERGRAPHOPTIONS.fields_by_name['face_landmarker_graph_options'].message_type = mediapipe_dot_tasks_dot_cc_dot_vision_dot_face__landmarker_dot_proto_dot_face__landmarker__graph__options__pb2._FACELANDMARKERGRAPHOPTIONS
