...
_TENSORSTOFACELANDMARKSGRAPHOPTIONS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='input_image_width', full_name='mediapipe.tasks.vision.face_landmarker.proto.TensorsToFaceLandmarksGraphOptions.input_image_width', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='input_image_height', full_name='mediapipe.tasks.vision.face_landmarker.proto.TensorsToFaceLandmarksGraphOptions.input_image_height', index=1,
