...
_SEGMENTEROPTIONS.fields_by_name['output_type'].has_options = True
_SEGMENTEROPTIONS.fields_by_name['output_type']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\030\001'))
