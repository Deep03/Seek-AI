...
_PACKETGENERATOROPTIONS.has_options = True
_PACKETGENERATOROPTIONS._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('\030\001'))
_PACKETGENERATORCONFIG.has_options = True
_PACKETGENERATORCONFIG._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('\030\001'))
