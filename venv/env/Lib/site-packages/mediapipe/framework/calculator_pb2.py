...
_CALCULATORGRAPHCONFIG.fields_by_name['packet_generator'].has_options = True
_CALCULATORGRAPHCONFIG.fields_by_name['packet_generator']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\030\001'))
